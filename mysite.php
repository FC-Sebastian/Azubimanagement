...
<div class="top">
    <a href="https://www.fatchip.de/" target="_blank">
        ...
        <img id="pic" src=<?php echo getPictureUrl($azubidata->getPicurl()) ?>>
        <br><br><br>
        <h1>
            <?php echo $azubidata->getName()?>
        </h1>
        <h2>Azubi zum Fachinformatiker Anwendungsentwicklung</h2>
        <?php if (!empty($azubidata->getBday())):?>
            <div>Geb.: <?php echo $azubidata->getBday();?></div>
        <?php endif; if (!empty($azubidata->getEmail())):?>
            <div  class="email">E-Mail:
                <a class="elink" href= <?php echo "mailto:".$azubidata->getEmail()?>><?php echo $azubidata->getEmail()?></a>
            </div>
        <?php endif?>
        <?php if (!empty($azubidata->getGithub())):?>
            <div >GitHub:
    ...
    <div class="lists">
        <?php if (!empty($azubidata->getPreskills())):?>
            <ol>
        ...
        <?php endif; ?>
        <?php if (!empty($azubidata->getNewskills())):?>
            <ul id="nskills">
        ...
        <?php endif; ?>
        <div id="timeedit">
            <a href="<?php getUrl("inputsite.php")?>?id=<?php echo $azubidata->getId()?>">edit <?php echo $azubidata->getName()?></a>
